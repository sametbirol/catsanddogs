<template>
    <v-card elevation="4" light tag="section">
        ...
        <v-card-text>
            <v-form id="myInput" v-autofocus>
                ...
                <v-text-field outline label="Email" type="text" v-model="credential.email" v-autofocus></v-text-field>
                <v-text-field outline label="FirstName" type="text" v-model="credential.first_name" v-autofocus></v-text-field>
                <v-text-field outline label="LastName" type="text" v-model="credential.last_name" v-autofocus></v-text-field>
    ...
    <pickyoursideModal v-model="modals.pickyourside" v-autofocus>
    </pickyoursideModal>
</template>
<script setup>
